  ...
  useEffect(() => {
    const handleMagicLogin = async () => {
      try {
        ...
        const response = await apiRequest('POST', '/api/auth/magic-login', { token });
        ...
        setStatus('error');
        setMessage('Login failed. This link may have expired or already been used.');
      }
    };
      ...
      <div className="w-full max-w-md">
        <Card className="shadow-lg">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              {status === 'loading' && 'Processing your secure login...'}
            ...
            {status === 'error' && (
              <div className="mt-4 text-center">
                <a 
                  ...
                  data-testid="link-request-new-magic-link"
                >
